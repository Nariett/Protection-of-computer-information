...
namespace Part01
{
    internal class Program
    {
        ...
        {
            StreamReader read = new StreamReader("C:\\Users\\samsi\\OneDrive\\Рабочий стол\\Code.txt");
            string text = read.ReadToEnd();
            read.Close();
            text = text.ToUpper();
            Console.WriteLine($"Ваш введенный текст в текстовый файл\n{text}");
            StreamReader readCode = new StreamReader("C:\\Users\\samsi\\OneDrive\\Рабочий стол\\Pass.txt");
